...
public class Tela extends javax.swing.JPanel {
    ...
    */
   public void criaPersonagem(int x, int y, String i) {
      if(i.equals("aldeao")){
      Personagem a = new Aldeao(this, "aldeao", x, y);
      a.desenhar(super.getGraphics());
      personagens.add(a);
      }
      if(i.equals("arqueiro")){
        Personagem a= new Arqueiro(this, "arqueiro", x, y);
        a.desenhar(super.getGraphics());
        personagens.add(a);
      }
      if(i.equals("cavaleiro")){
          Personagem a=new Cavaleiro(this,"cavaleiro",x,y);
          a.desenhar(super.getGraphics());
          personagens.add(a);
      }
      if(i.equals("guerreiro")){
          Personagem a=new guerreiro(this,"guerreiro",x,y);
          a.desenhar(super.getGraphics());
          personagens.add(a);
      }
   }
    ...
    * @param direcao 
    */
   public void movimentarPersonagem(int direcao, String i){
      for (Personagem p : personagens) {
          if(i.equals("todos")){
              p.mover(direcao,p.nome());
          }
          else if(i.equals(p.nome())){
           p.mover(direcao,i);   
          }
      }
    ...
    */
   public void atacarPersonagem(String i){
       for (Personagem p : personagens) {
          if(i.equals(p.nome())){
           p.atacar();   
          }
